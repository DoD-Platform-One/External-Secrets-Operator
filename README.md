...
| image.tag | string | `"v0.17.0"` | The image tag to use. The default is the chart appVersion. |
...
| webhook.image.tag | string | `"v0.17.0"` | The image tag to use. The default is the chart appVersion. |
...
| certController.image.tag | string | `"v0.17.0"` |  |
